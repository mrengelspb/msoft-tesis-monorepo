...
class Graph:
    def __init__(self, board_shim):
        ...
        try:
            ...
            # 1. Obtenemos TODOS los canales ECG
            all_ecg_channels = BoardShim.get_ecg_channels(self.board_id)
            # 2. Nos quedamos solo con los dos primeros
            self.ecg_channels = all_ecg_channels[:2] # <--- ¡ESTE ES EL CAMBIO!
        ...
        # Ajustamos el tamaño de la ventana para que sea menos alta
        self.win = pg.GraphicsLayoutWidget(title='Monitor ECG (2 Canales)', size=(1000, 400), show=True)
    ...
    def _init_pens(self):
        self.pens = list()
        self.brushes = list()
        # Solo necesitamos 2 colores, pero podemos dejar la lista como estaba
    ...
    def _init_timeseries(self):
        ...
        # Este bucle ahora solo se ejecutará 2 veces
