...
class Graph:
    def __init__(self, board_shim):
        ...
        self.printed_data = False # <--- AÑADE ESTA LÍNEA            
        ...
        for count, channel in enumerate(self.ecg_channels):
            ...
            if count == 0:
                try:
                    ...
                    # 3.2. Definir el rango de frecuencia cardíaca (0.8Hz-2.5Hz -> 48-150 BPM)
                    min_hr_hz = 0.8
                    max_hr_hz = 2.5
...
def main():
    ...
    # --- LÍNEA CLAVE ---
    # Envía el comando de configuración a C++
    # Prueba con 180, 120, 60, etc.
    bpm_deseado = 180.0 
